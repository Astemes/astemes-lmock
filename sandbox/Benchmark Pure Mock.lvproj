...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Pure Mock Test" Type="Folder">
			...
			<Item Name="LMock Pure Test Case 1.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Mock Test Case 1/LMock Pure Test Case 1.lvclass"/>
			<Item Name="LMock Pure Test Case 2.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Test Case 2/LMock Pure Test Case 2.lvclass"/>
			<Item Name="LMock Pure Test Case 3.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Test Case 3/LMock Pure Test Case 3.lvclass"/>
			<Item Name="LMock Pure Test Case 4.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Mock Test Case 4/LMock Pure Test Case 4.lvclass"/>
			<Item Name="LMock Pure Test Case 5.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Test Case 5/LMock Pure Test Case 5.lvclass"/>
			<Item Name="LMock Pure Test Case 6.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Test Case 6/LMock Pure Test Case 6.lvclass"/>
			<Item Name="LMock Pure Test Case 7.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Test Case 7/LMock Pure Test Case 7.lvclass"/>
			<Item Name="LMock Pure Test Case 8.lvclass" Type="LVClass" URL="../Benchmark/LMock Pure Test Case 8/LMock Pure Test Case 8.lvclass"/>
			<Item Name="LMock Pure Test Case 9.lvclass" Type="LVClass" URL="../Benchmark/of LMock Pure Test Case 9/LMock Pure Test Case 9.lvclass"/>
			<Item Name="LMock Pure Test Case 10.lvclass" Type="LVClass" URL="../Benchmark/of LMock Pure Test Case 9/LMock Pure Test Case 10/LMock Pure Test Case 10.lvclass"/>
		</Item>
		<Item Name="Responsive Mock.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Astemes/LMock/Responsive Mock.lvclass"/>
		<Item Name="Test Interface Pure Mock.lvclass" Type="LVClass" URL="../Benchmark/Test Interface Pure Mock/Test Interface Pure Mock.lvclass"/>
