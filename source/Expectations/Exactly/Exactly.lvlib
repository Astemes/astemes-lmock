...
<Library LVVersion="20008000">
	...
	<Item Name="Variants" Type="Folder">
		<Item Name="Exactly Identical Inputs.vi" Type="VI" URL="../Exactly Identical Inputs.vi"/>
		<Item Name="Exactly Tolerant Inputs.vi" Type="VI" URL="../Exactly Tolerant Inputs.vi"/>
		<Item Name="Exactly Matching String Inputs.vi" Type="VI" URL="../Exactly Matching String Inputs.vi"/>
		<Item Name="Exactly Ignore Inputs.vi" Type="VI" URL="../Exactly Ignore Inputs.vi"/>
	</Item>
	<Item Name="Exactly.lvclass" Type="LVClass" URL="../Exactly.lvclass">
